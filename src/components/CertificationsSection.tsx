...
const certifications = [
  {
    ...
    code: "LFD140",
    pdfPath: "/certificates/linux-foundation.pdf",
    color: "primary",
    icon: "🐙",
  },
  {
  ...
  },
  {
    ...
    pdfPath: "/certificates/aws-mgn.pdf",
    color: "primary",
    icon: "☁️",
  },
  {
    ...
    pdfPath: "/certificates/nielit-bootcamp.pdf",
    color: "accent",
    icon: "📊",
  },
  {
    ...
    issuer: "Forage",
    pdfPath: "/certificates/forage-software.pdf",
    color: "primary",
    icon: "💼",
  },
  {
    ...
    issuer: "Forage",
    pdfPath: "/certificates/forage-genai.pdf",
    color: "accent",
    icon: "📈",
  },
  {
    ...
    issuer: "Forage",
    pdfPath: "/certificates/forage-data-analytics.pdf",
    color: "primary",
    icon: "📉",
  },
  {
    ...
    issuer: "Forage",
    pdfPath: "/certificates/forage-solutions.pdf",
    color: "accent",
    icon: "🏗️",
  },
];
        ...
        >
          <div className="glass-card px-6 py-3 inline-flex items-center gap-3">
            ...
            <span className="text-sm text-muted-foreground">
              <span className="text-primary font-bold">{certifications.length}+</span> Industry Certifications
            </span>
          </div>
        </motion.div>
      </div>
        ...
        {selectedCert && (
          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between p-6 border-b border-border/50">
                <div className="flex items-center gap-4">
                  <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl ${
                    selectedCert.color === "primary" ? "bg-primary/10" : "bg-accent/10"
                  }`}>
                    {selectedCert.icon}
                  </div>
                  <div>
              ...
              {/* PDF Viewer */}
              <div className="p-6">
                <div className="w-full h-[60vh] rounded-xl overflow-hidden bg-muted/50">
                  <iframe
